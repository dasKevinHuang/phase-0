...
//
//  The only tests I had trouble passing were the ones involving the children objects. I skimmed over the instructions and did not realize that each child was supposed to be an object in itself.
//  So it was a simple fix by defining each child as an object, prefilled with the name. It worked, because it tells the console that each child is an object with its own properties.
//
//How difficult was it to add and delete properties outside of the object itself?
//
//  Not difficult at all. It was pretty simple. I only had to look up how to delete properties, adding properties was pretty straightforward and reminiscent of adding hash keys in Ruby.
//
//What did you learn about manipulating objects in this challenge?
//
//  I learned about different situations and the subtleties for using different notations with objects.
//  Overall it was a pretty easy challenge, and it allowed me to experiement with different ways of working with objects.
//
//
